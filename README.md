...
| --- | --- | --- |
| [**SkyCommand**](https://github.com/PStar1980/SkyCommand) | Full-stack workflow automation and data-operations control plane with durable orchestration, ingestion governance, recovery, repository tooling, and operational observability. | Node.js, React, JavaScript, Express, Knex, Temporal, PostgreSQL, ECharts, D3.js |
| [**SkyWeb Analytics**](https://github.com/PStar1980/SkyWeb) | Full-stack macroeconomic analytics platform with interactive dashboards, alerts, custom views, and decision-grade visual evidence. | ASP.NET Core, React, C#, Dapper, PostgreSQL, ECharts, D3.js |
